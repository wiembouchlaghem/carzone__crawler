...
# ======== Ici vous trouvez la config du PROXY =======
PROXY_URL = os.environ.get("PROXY_URL")
if not PROXY_URL:
    raise RuntimeError("PROXY_URL n'est pas configuré. Set environment variable PROXY_URL.")
...
def get_chrome_options(user_agent=None):
    ...
    # Désactiver les flags Selenium qui trahissent l'automatisation
...
def fetch_page(page_num):
    ...
    # Nouveau format du nom du fichier
